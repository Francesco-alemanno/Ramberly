...
const setupDb = async () => {
  try {
    ...
    `);
    // await db.none(
    //   `INSERT INTO users (nome, cognome, email, password, livello, img, sesso, peso, eta, attivita, monitoraggio, gruppo, sfide, running, escursione, biking, camminata, seguiti, seguaci)
    //   VALUES
    ...
    //   `,
    //   [
    //     "Luca", "Rossi", "luca.rossi@email.com", "Pass123!", 3, readImage(avatars.luca), "M", 75, 28, "2", "si", "gruppo", "si", true, false, false, true, [2, 3], [5, 6, 7],
    //     "Giulia", "Bianchi", "giulia.bianchi@email.com", "Pass123", 5, readImage(avatars.giulia), "F", 60, 32, "4", "si", "entrambi", "si", false, true, false, true, [1, 4], [3, 8],
    //     "Sara", "Neri", "sara.neri@email.com", "Pass123", 2, readImage(avatars.sara), "F", 55, 25, "5", "si", "solo", "si", false, false, false, true, [2, 5], [6, 7, 9],
    //     "Davide", "Gialli", "davide.gialli@email.com", "Pass123", 7, readImage(avatars.davide), "M", 85, 40, "2", "si", "entrambi", "si", true, false, false, false, [1, 3, 4], [8, 9, 10],
    //     "Elisa", "Blu", "elisa.blu@email.com", "Pass123", 4, readImage(avatars.elisa), "F", 68, 35, "4", "si", "gruppo", "si", false, true, false, false, [2, 7, 9], [1, 3, 5],
    //     "Antonio", "Viola", "antonio.viola@email.com", "Pass123", 6, readImage(avatars.antonio), "M", 90, 50, "2", "si", "gruppo", "si", false, false, true, false, [5, 6], [1, 2, 10],
    //     "Federico", "Marrone", "federico.marrone@email.com", "Pass123", 8, readImage(avatars.federico), "M", 78, 45, "2", "si", "solo", "si", true, false, false, false, [2, 4, 6], [1, 3, 5, 7],
    //     "Chiara", "Grigio", "chiara.grigio@email.com", "Pass123", 5, readImage(avatars.chiara), "F", 62, 31, "4", "si", "solo", "si", false, true, false, true, [3, 8], [4, 6, 9],
    //   ]
    // );
    await db.none(`
